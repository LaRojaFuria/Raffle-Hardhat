...
const FUND_AMOUNT =
    network.name === "localhost" ? ethers.utils.parseEther("1") : ethers.utils.parseEther("0.1") // Adjusted for other networks
...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    try {
        ...
        const raffle = await upgrades.deployProxy(Raffle, raffleArgs, { initializer: "initialize" })
